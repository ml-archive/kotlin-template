    ...
    fun provideTestUserLoginStates(): MutableList<LoginState> {
        ...
        u.add(
            LoginState(
                selectedUser = User(
                    id = -2,
                    name = "Charlie Testburger (0703161319)",
                    identity = "0703161319"
                ),
        ...
        u.add(
            LoginState(
                selectedUser = User(
                    id = -3,
                    name = "Boxie Fairshare (0805730045)",
                    identity = "0805730045"
                ),
        ...
        u.add(
            LoginState(
                selectedUser = User(
                    id = -4,
                    name = "Signe Signfeature (090906-1349)",
                    identity = "0909061349"
                ),
        ...
        u.add(
            LoginState(
                selectedUser = User(
                    id = -5,
                    name = "You got served (090906-1346)",
                    identity = "0909061346"
                ),
        ...
        u.add(
            LoginState(
                selectedUser = User(
                    id = -8,
                    name = "Laila Dollarmeyer (3010732572)",
                    identity = "3010732572"
                ),
        ...
        u.add(
            LoginState(
                selectedUser = User(
                    id = -9,
                    name = "Norway (08101500011 NO Snitflade)",
                    identity = "08101500011"
                ),
        ...
        u.add(
            LoginState(
                selectedUser = User(
                    id = -10,
                    name = "Sweden (201508101234 SE Snitflade)",
                    identity = "201508101234"
                ),
        ...
        u.add(
            LoginState(
                selectedUser = User(
                    id = -11,
                    name = "Sec Level (SE) (197707096066)",
                    identity = "197707096066"
                ),
        ...
        u.add(
            LoginState(
                selectedUser = User(
                    id = -12,
                    name = "Sec Level (NO) (15079411032)",
                    identity = "15079411032"
                ),
