...
class ForgotPasswordDoneComponentFragment : BaseFragment(),
    cz.levinzonr.keychain.presentation.components.ForgotPasswordDoneComponentContract.View {

    @Inject
    lateinit var presenter: cz.levinzonr.keychain.presentation.components.ForgotPasswordDoneComponentContract.Presenter
