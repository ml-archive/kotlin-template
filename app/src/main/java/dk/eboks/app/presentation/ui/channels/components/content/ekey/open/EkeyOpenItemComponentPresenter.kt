 ...
 */
class EkeyOpenItemComponentPresenter @Inject constructor(val appState: AppStateManager,
                                                         val encryptedPreferences: EncryptedPreferences,
                                                         val setEKeyVaultInteractor: SetEKeyVaultInteractor
) : EkeyOpenItemComponentContract.Presenter, BasePresenterImpl<EkeyOpenItemComponentContract.View>(), SetEKeyVaultInteractor.Output {
    ...
    override fun putVault(items: MutableList<BaseEkey>) {
