 ...
 */
class IdPortenComponentPresenter @Inject constructor(appState: AppStateManager, transformTokenInteractor: TransformTokenInteractor, verifyProfileInteractor: VerifyProfileInteractor) :
        WebLoginPresenter(appState, transformTokenInteractor, verifyProfileInteractor) {
