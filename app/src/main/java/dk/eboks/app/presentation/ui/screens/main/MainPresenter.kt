 ...
 */
class MainPresenter(val loginInteractor: LoginInteractor) : dk.eboks.app.presentation.ui.screens.main.MainContract.Presenter, BasePresenterImpl<MainContract.View>(), LoginInteractor.Output {
    init {
